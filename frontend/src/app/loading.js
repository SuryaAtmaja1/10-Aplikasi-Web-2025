export default function PageLoading({ message = "Sedang memuat laman" }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Loader content */}
      <div className="relative rounded-[12px] px-[40px] py-[64px] bg-putih shadow-xl flex flex-col items-center gap-[40px]">
        ...
        <div className="flex flex-col text-center">
          <p className="text-h8 mb-[4px] font-PulsarOriginal font-semibold">Tolong tunggu...</p>
          <p className="text-body-xl font-[400] text-[#666666]">{message}</p>
        </div>
      </div>
    </div>
  );
