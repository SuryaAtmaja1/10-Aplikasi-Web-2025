  ...
  return(
    <div className="relative font-jakarta">
      ...
      <div className="hidden relative md:flex flex-col h-fit mt-28 mb-40 lg:mb-64">
        <div className="absolute w-full h-[24vh] lg:h-[36vh] xl:h-[42vh] 2xl:h-[46.296vh] bg-oren translate-y-[7.5vh] lg:translate-y-[11.7vh] xl:translate-y-[15.7vh] 2xl:translate-y-[14.5vh]"></div>
        ...
        <div className="relative flex flex-row gap-6 lg:gap-12 2xl:gap-18 px-6 xl:px-12">
          <article className="">
            <Image
              src={Technocorner}
              className="w-[37.5vw]"
          ...
          <div className="absolute right-0 flex flex-col items-end px-6 xl:px-12 origin-top-right scale-45 lg:scale-67 xl:scale-73 2xl:scale-100">
            <div className="bg-hitam p-6 "><ArrowUpRight /></div>
            <h3 className="text-right text-[2.5rem]/11.5 font-extrabold text-putih mt-6">Pelajari<br />Lebih<br />Lanjut<br />...</h3>
          </div>
        </div>
      </div>
      {/* Mobile */}
