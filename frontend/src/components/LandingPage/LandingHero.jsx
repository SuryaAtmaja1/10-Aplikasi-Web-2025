    ...
    <div className="font-jakarta w-[88.889vw] md:w-[75.833vw] h-[75vh] place-self-center mt-10 md:mb-24 ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 lg:gap-5 h-full duration-300 ease-in-out">
        ...
        <div className="h-full flex flex-col gap-2 md:gap-4 lg:gap-5">
          ...
          <Link
            href="/sajak/post"
            className="group relative flex md:grow overflow-hidden rounded-lg md:rounded-2xl h-full md:h-auto border transform transition duration-1000 ease-in-out hover:scale-105"
          >
            ...
            <div className="hidden absolute md:flex items-center justify-between w-full h-fit bottom-0 right-0 mb-2.5 motion-safe:transition">
              <h1 className="font-jakarta font-bold text-4xl xl:text-6xl 2xl:text-[5.3rem] text-nowrap ml-2.5 motion-safe:duration-1000 ease-in-out group-hover:-translate-y-30">
                TULIS SAJAK
              </h1>
            ...
            <h1 className="md:hidden absolute bottom-0 right-0 font-jakarta font-bold text-2xl text-nowrap">
              TULIS SAJAK
            </h1>
          ...
          <a
            href="/sajak/panduan"
            className="group relative flex flex-row items-center justify-between gap-3 overflow-hidden rounded-lg md:rounded-2xl h-fit py-2.5 md:py-4 px-2.5 md:px-6 border hover:-translate-y-1 active:bg-oren transform transition"
          >
            <p className="font-instrument italic text-sm md:text-base xl:text-2xl">
              Pertama kali di sini?
            </p>
            <div className="flex items-center gap-2 xl:gap-5 justify-center">
              <p className="font-jakarta font-bold group-hover:underline text-xs md:text-sm xl:text-lg text-oren group-active:text-putih justify-center">
                Ikuti panduan kami.
              </p>
          ...
          <div className="flex flex-row items-center justify-center gap-2 md:gap-6 h-[32.32%] w-full">
            ...
            <a
              href=""
              className="group relative flex items-center justify-center overflow-hidden rounded-lg md:rounded-2xl h-full w-full border hover:zoom active:scale-95"
            >
              <h2 className="absolute font-jakarta font-extrabold text-2xl md:text-5xl text-biru opacity-[.67] top-2 md:top-6 left-2 md:left-4">
                TOTAL
              </h2>
              <h2 className="absolute font-jakarta font-extrabold text-2xl md:text-5xl text-biru opacity-[.67] bottom-2 md:bottom-6 right-2 md:right-4 mt-6 ml-4">
                KARYA
              </h2>
              <Image
                src={Bunga}
                ...
                alt="gambar bunga"
              />
              <h1 className="z-10 font-instrument text-6xl md:text-7xl lg:text-8xl 2xl:text-9xl text-cerise group-hover:scale-120 duration-670 ease-in-out transform transition">
                67,676
              </h1>
            </a>
            {/* kocheng */}
            <Link
              href="#agendaKomunitas"
              scroll={false}
              onClick={scrollToTarget}
              className="group relative overflow-hidden rounded-lg md:rounded-2xl h-full w-[64.76%] transform transition duration-200 ease-in-out hover:scale-120 active:scale-90"
            >
